...
const CHECKOUT_APP_MENSAL = 'https://pay.hotmart.com/SEU_LINK_APP_MENSAL'; // R$ 27,90/mês — PetVetly completo
const CHECKOUT_APP_ANUAL = 'https://pay.hotmart.com/SEU_LINK_APP_ANUAL';   // R$ 147/ano — PetVetly completo anual
